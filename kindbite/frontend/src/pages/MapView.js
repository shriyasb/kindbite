      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-5 flex items-center justify-between flex-wrap gap-3">
          <div>
            ...
            <p className="text-gray-500 text-sm mt-0.5">{posts.length} active donation{posts.length !== 1 ? 's' : ''} available</p>
          </div>
              ...
              <div key={post._id} onClick={() => setSelected(post)}
                ...
                <div className="flex gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <div className="text-xs text-gray-400 mt-0.5">{post.quantity} servings · {formatDistanceToNow(new Date(post.expiryTime), { addSuffix: true })}</div>
          ...
          <div className="card mt-5">
            ...
            <div className="grid md:grid-cols-2 gap-4 mt-3">
              <div className="space-y-2 text-sm text-gray-600">
                <p><span className="font-medium">Donor:</span> {selected.donor?.name || selected.donor?.organization}</p>
                <p><span className="font-medium">Food type:</span> {selected.foodType}</p>
                <p><span className="font-medium">Quantity:</span> {selected.quantity} servings</p>
                <p><span className="font-medium">Address:</span> {selected.address}</p>
                <p><span className="font-medium">Expires:</span> {formatDistanceToNow(new Date(selected.expiryTime), { addSuffix: true })}</p>
              </div>
